...
// Which of these four topics a message is asking about is decided by module-resolver.ts's
// `classifyTopic` (a faithful port of module_resolver.py's real `classify_topic`) +
