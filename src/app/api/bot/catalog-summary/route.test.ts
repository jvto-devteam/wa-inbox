      ...
      packages: [
        {
          ...
          origin: 'Surabaya', dayCount: 3, finishCities: [], priceTiers: [],
          overnights: [], roomingAssumption: null, vehicleCategory: null, luggageRule: null, crewRoles: null, languageNote: null,
        },
      ],
    })
