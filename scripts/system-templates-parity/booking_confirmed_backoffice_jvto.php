<?php
// Parity: booking_confirmed_backoffice_jvto — new-backoffice BookingController::store, the
// is_send_wa message, with booking_category_id = 1 (3 = Klook; anything else takes the JVTO paragraph).
...
$booking = (object) ['booking_category_id' => 1, 'url' => 'a1b2c3d4-example'];
