<?php
// Parity: payment_method_confirmed_cash — javavolcano-touroperator frontend CheckoutController::setPaymentMethod,
// branch request->type == 'cash'. Only the lines that feed the message are copied; the Xendit
...
// --- end verbatim ---
// --- verbatim: javavolcano-touroperator/app/Http/Controllers/frontend/CheckoutController.php:1134-1135 ---
                $payment_method = "Cash";
                $paymentMethod = "Cash";
// --- end verbatim ---
