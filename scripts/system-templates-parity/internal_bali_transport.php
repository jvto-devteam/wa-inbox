<?php
// Parity: internal_bali_transport — javavolcano-touroperator XenditController::sendBaliNotif.

function build(array $data): string
{
    $dataSending = array();
// --- verbatim: javavolcano-touroperator/app/Http/Controllers/thirdParty/XenditController.php:499-499 ---
            $dataSending["message"] = "*Transport Service Bali*\r\n\r\n🗓 Tanggal : " . $data['date'] . "\r\n\r\n🕤 Jam Pickup : " . $data['pickup_time'] . "\r\n\r\n👥 Tamu : " . $data['customer'] . " (" . $data['pax'] . " pax) \r\n\r\n🚗 Unit : " . $data['unit'] . "\r\n\r\n📍 Pickup : " . $data['pickup'] . "\r\n\r\n🏁 Drop : " . $data['drop'] . "\r\n\r\n✅ Tambahan : " . $data['others'];
// --- end verbatim ---
